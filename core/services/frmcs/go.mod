...
module github.com/mmt/mmt-studio-core/services/frmcs

go 1.21

require (
	github.com/mmt/mmt-studio-core/oam v0.0.0
	github.com/mmt/mmt-studio-core/services/mcx v0.0.0
)
...
require (
	...
	github.com/mmt/mmt-studio-core/db v0.0.0 // indirect
...
replace (
	...
	github.com/mmt/mmt-studio-core/services/mcx => ../mcx
)
