...
module github.com/mmt/mmt-studio-core/nf

go 1.21

require (
	github.com/mmt/asn1go v0.0.0
	github.com/mmt/mmt-studio-core/db v0.0.0
	github.com/mmt/mmt-studio-core/libs/sacrypto v0.0.0
	github.com/mmt/mmt-studio-core/oam v0.0.0
	github.com/mmt/nasgen v0.0.0
	github.com/mmt/pfcpgen v0.0.0
)
...
replace (
	...
	github.com/mmt/pfcpgen => ../codecs/tlv-3gpp-pfcp/pfcpgen
)
